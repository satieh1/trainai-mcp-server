// server.cjs — MCP HTTP/SSE server that proxies to Train.ai FastAPI (CommonJS)
const express = require('express');
const cors = require('cors');
// Node 18+ has global fetch; no node-fetch needed
const { Server: McpServer } = require('@modelcontextprotocol/sdk');
const { SSEServerTransport } = require('@modelcontextprotocol/sdk/transports/sse/server');
